  ...
  "inline-flex items-center justify-center whitespace-nowrap rounded-lg text-sm font-medium ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 active:scale-[0.98]",
  {
    variants: {
      variant: {
        ...
        outline:
          "border-2 border-input bg-transparent hover:bg-accent hover:text-accent-foreground hover:border-accent dark:border-dark-input dark:hover:border-dark-accent dark:hover:bg-dark-accent dark:hover:text-dark-accent-foreground",
        secondary:
          "bg-muted text-muted-foreground shadow-sm hover:shadow-md hover:bg-muted/80 dark:bg-dark-muted dark:text-dark-muted-foreground dark:hover:bg-dark-muted/80",
        ghost:
