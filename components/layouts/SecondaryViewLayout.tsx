...
export function SecondaryViewLayout({
  ...
  return (
    <div className="flex flex-col md:flex-row flex-1 h-full overflow-hidden gap-4 md:gap-6">
      ...
      <aside className="w-full md:w-1/3 rounded-xl border border-border overflow-y-auto bg-gradient-to-br from-card to-card/95 backdrop-blur-sm p-4 h-full min-h-[300px] md:min-h-full shadow-soft">
        {middleColumn}
      </aside>
